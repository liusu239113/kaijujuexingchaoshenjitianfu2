...
object Content {
    ...
    val normalNames = listOf(
        ...
        "青苔影狼", "寒骨弓手", "翠毒蛙卫", "紫晶岩魔", "鬼焰咒师", "荆花树卫",
        "熔岩毒蝎", "双首狱犬", "黑曜熔巨人", "赤羽火凰", "熔铁犀卫", "焚骨骑士",
        "晶甲雪熊", "冰晶翼龙", "霜尾灵狐", "冰锤雪人", "寒骨巫妖", "极光霜鹿",
        "雷羽巨鹰", "雷角天马", "电铠剑齿虎", "雷锤山巨人", "雷脊蜈蚣", "雷云浮灵",
        "渊眼触手怪", "血月幽灵", "黑翼魔姬", "渊海巨章", "无面潜行者", "深渊魔蛛",
        "黄铜机蛛", "重锤机兵", "赤眼浮炮", "蒸汽狮鹫", "古代机关守卫", "晶核守塔兽",
        "瘴毒巨蛇", "孢子菌兽", "腐沼巨鳄", "酸液胶王", "翡翠毒蜂", "瘟疫羊首巫医",
        "残翼圣像", "堕落圣骑", "耀翼狮鹫", "日蚀术师", "银枪人马", "圣辉棱魔",
        "星海巨鲸", "紫晶星鹿", "彗尾天龙", "虚空星卫", "极光仙灵", "星团蝶皇",
    )
    ...
    // 固定楼层剧情也要进入 id 索引，才能从存档恢复；不会加入随机奇遇池。
