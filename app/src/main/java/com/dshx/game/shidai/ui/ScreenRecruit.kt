    ...
    when {
        ...
        id.startsWith("rec_hire_") -> {
            ...
            if (TowerService.recruit(p, u)) {
                ...
                com.dshx.game.shidai.game.RunService.recalcAll(p, perm)
                com.dshx.game.shidai.game.Tracker.bump(perm, "recruit")
                if (p.party.size >= 3) com.dshx.game.shidai.game.Tracker.bump(perm, "party3")
