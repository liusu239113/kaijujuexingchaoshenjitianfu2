...
object Content2 {
    ...
    val extraTalents = listOf(
        ...
        Talent("t_blood_moon", "绯月", Rarity.LEGENDARY, School.VITA, "吸血 +25%，生命上限 +12%。", flat = mapOf("lifesteal" to 25.0), passive = null),
        ...
        Talent("t_fate_weaver", "织命者", Rarity.LEGENDARY, School.FATE, "闪避 +20%，暴击 +10%，能量回复 +6。", mapOf("dodge" to 20.0, "crit" to 10.0), flat = mapOf("energyRegen" to 6.0)),

        // 灿烂
        Talent("t_hunter", "猎手", Rarity.EPIC, School.EDGE, "对精锐与首领增伤 +18%。", passive = "elite_hunter"),
        Talent("t_medic", "急救专家", Rarity.EPIC, School.VITA, "治疗效果 +30%，每回合回复 1% 生命。", flat = mapOf("healPower" to 0.30), passive = "regen1"),
        Talent("t_haste", "急速", Rarity.EPIC, School.FATE, "能量回复 +7。", flat = mapOf("energyRegen" to 7.0)),
        ...
        Talent("t_bulwark2", "重盾", Rarity.EPIC, School.WARD, "护盾效果 +30%，防御 +12%。", mapOf("def" to 0.12), flat = mapOf("shieldPower" to 0.30)),
        ...
        Talent("t_arcane_focus", "奥术专注", Rarity.EPIC, School.ARC, "法强 +16%，无视 10% 防御。", mapOf("matk" to 0.16), flat = mapOf("armorPen" to 0.10)),
        ...
        Talent("t_matk_r2", "秘典", Rarity.RARE, School.ARC, "法强 +10%，能量回复 +3。", mapOf("matk" to 0.10), flat = mapOf("energyRegen" to 3.0)),
        Talent("t_def_r2", "铁甲", Rarity.RARE, School.WARD, "防御 +10%，最大生命 +6%。", mapOf("def" to 0.10, "maxHp" to 0.06)),
        Talent("t_hp_r2", "坚韧体魄", Rarity.RARE, School.VITA, "最大生命 +14%，每回合回复 12 生命。", mapOf("maxHp" to 0.14), flat = mapOf("hpRegen" to 12.0)),
        Talent("t_critdmg_r2", "致命一击", Rarity.RARE, School.FATE, "暴击增伤 +35%。", mapOf("critDmg" to 35.0)),
        Talent("t_dodge_r2", "风影", Rarity.RARE, School.FATE, "闪避 +10%，能量回复 +2。", mapOf("dodge" to 10.0), flat = mapOf("energyRegen" to 2.0)),
        Talent("t_shield_r2", "护盾锻铸", Rarity.RARE, School.WARD, "护盾效果 +25%。", flat = mapOf("shieldPower" to 0.25)),
        Talent("t_heal_r2", "治愈之手", Rarity.RARE, School.VITA, "治疗效果 +25%。", flat = mapOf("healPower" to 0.25)),
        ...
        Talent("t_flat_hp2", "生命宝石", Rarity.COMMON, School.VITA, "最大生命 +60。", flat = mapOf("maxHp" to 60.0)),
        Talent("t_flat_atk2", "锐石", Rarity.COMMON, School.EDGE, "攻击 +10。", flat = mapOf("atk" to 10.0)),
        Talent("t_flat_matk2", "魔石", Rarity.COMMON, School.ARC, "法强 +10。", flat = mapOf("matk" to 10.0)),
        Talent("t_flat_def2", "岩片", Rarity.COMMON, School.WARD, "防御 +6。", flat = mapOf("def" to 6.0)),
        Talent("t_resist_c", "抗性", Rarity.COMMON, School.WARD, "状态抗性 +10。", flat = mapOf("statusRes" to 10.0)),
        Talent("t_pen_c", "破防", Rarity.COMMON, School.EDGE, "无视 6% 防御。", flat = mapOf("armorPen" to 0.06))
    )
}
